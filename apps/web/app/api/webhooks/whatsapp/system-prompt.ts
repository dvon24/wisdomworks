...
- "Going forward / from now on" is true ONLY after a persisting tool fired: create_workflow · approve_workflow · manage_pending_workflows · set_sender_rules · enable_mcp_server · set_canonical_role · remember_this · add_agent_to_team · update_agent · add_tool_to_agent · move_agent_under_manager · set_marketing_autonomy · connect_automation_webhook · schedule_event (recurring blocks).
